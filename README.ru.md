...
Spigot плагин, который добавляет замки и кодовые замки для дверей, люков, бочек и сундуков.
...
Видео с инструкцией по использованию плагина есть на моем YouTube-канале по этой [ссылке](https://youtu.be/pOgOVg9vnRY).
...
`enable_resourcepack` - Настройка включения пользовательского пакета ресурсов для плагина. Введите 'false', если хотите играть без него или встраиваете пакет ресурсов в свой сервер локально. По умолчанию: true.
